...
namespace CinemaApp.Data.Utilities
{
    ...
    {
        public static async Task ImportMoviesFromJson(CinemaAppDbContext context)
        {
        ...
        public static async Task ImportCinemaMoviesFromJson(CinemaAppDbContext context)
        {
            ...
            var movieTitles = cinemasMovies.Select(m => m.Movie)
                .ToArray();
        ...
        public static async Task ImportTicketsFromXml(CinemaAppDbContext context)
        {
